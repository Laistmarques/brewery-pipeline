...
def test_silver_job_orchestrates_reader_transformer_writer():
    ...
    """
    Teste para verificar se o job da camada Silver está orquestrando corretamente as chamadas para o reader, transformer e writer. 
    O teste cria mocks para cada componente, define os retornos esperados e depois checa se as chamadas foram feitas com os argumentos corretos.
    """
